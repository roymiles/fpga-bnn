...
void classifyRegions(cv::Mat &curFrame, std::vector<cv::Rect> &regions, std::vector<std::string> &classes, std::vector<int> &outputs, std::vector<float> &certainties, bool bundleRegions = false);
