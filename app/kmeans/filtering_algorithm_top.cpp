...
// centre positions
data_type centre_positions[MAX_CENTRES];
// tree search output
centre_type filt_centres_out[MAX_CENTRES];
...
// centre positions
data_type centre_positions[MAX_CENTRES][P];
//tree search output
centre_type filt_centres_out[MAX_CENTRES][P];
                                ...
                                volatile data_type *clusters_out)
{
    ...
    */
    ...
    #ifdef PARALLELISE
        centre_type filt_centres_out_reduced[MAX_CENTRES];
    ...
    data_type new_centre_positions[MAX_CENTRES];

    // iterate over a constant number of outer clustering iterations
    it_loop: for (uint l=0; l<MAX_OUTER_ITERATIONS; l++) {
        ...
        // if we have parallel tree searches, we need to perform a reduction after all units are done
            ...
            for(centre_index_type i=0; i<=k; i++) {
                ...
                for (uint d=0; d<DATA_DIMENSIONS; d++) {
                    #pragma HLS unroll
                               ...
                               centre_index_type k)
{
    ...
    centre_type centre_buffer[MAX_CENTRES];
            ...
            centre_type *centres_out)
{
    ...
    //stack
    stack_record stack_array[MAX_DATA_POINTS];
    cstack_record_type cstack_array[MAX_DATA_POINTS];
    ...
    tree_search_loop: while (node_stack_length != 0) {
        ...
        data_type tmp_centre_positions[MAX_CENTRES];
        centre_index_type tmp_centre_indices[MAX_CENTRES];
        ...
        centre_index_type tmp_centre_indices_out[MAX_CENTRES];
